...
#define __PYX_HAVE__PoissonSolver__matvec2D
#define __PYX_HAVE_API__PoissonSolver__matvec2D
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'PoissonSolver.matvec2D' */
...
#define __Pyx_MODULE_NAME "PoissonSolver.matvec2D"
extern int __pyx_module_is_main_PoissonSolver__matvec2D;
int __pyx_module_is_main_PoissonSolver__matvec2D = 0;

/* Implementation of 'PoissonSolver.matvec2D' */
...
static const char __pyx_k_PoissonSolver_matvec2D[] = "PoissonSolver.matvec2D";
...
static const char __pyx_k_PoissonSolver_MV_2D_cy_matvec2D[] = "PoissonSolver/MV_2D_cy/matvec2D.pyx";
...
static PyObject *__pyx_kp_s_PoissonSolver_MV_2D_cy_matvec2D;
static PyObject *__pyx_n_s_PoissonSolver_matvec2D;
...
/* Python wrapper */
static PyObject *__pyx_pw_13PoissonSolver_8matvec2D_1matvec2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13PoissonSolver_8matvec2D_1matvec2D = {"matvec2D", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13PoissonSolver_8matvec2D_1matvec2D, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13PoissonSolver_8matvec2D_1matvec2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_kmax;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("PoissonSolver.matvec2D.matvec2D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13PoissonSolver_8matvec2D_matvec2D(__pyx_self, __pyx_v_i, __pyx_v_j, __pyx_v_kmax, __pyx_v_celldm3, __pyx_v_pi, __pyx_v_epsGz_perp, __pyx_v_epsGz_ll, __pyx_v_b_1, __pyx_v_b_2, __pyx_v_V);
...
static PyObject *__pyx_pf_13PoissonSolver_8matvec2D_matvec2D(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_i, int __pyx_v_j, int __pyx_v_kmax, double __pyx_v_celldm3, double __pyx_v_pi, __Pyx_memviewslice __pyx_v_epsGz_perp, __Pyx_memviewslice __pyx_v_epsGz_ll, __Pyx_memviewslice __pyx_v_b_1, __Pyx_memviewslice __pyx_v_b_2, __Pyx_memviewslice __pyx_v_V) {
  ...
  for (__pyx_t_13 = (-__pyx_v_kmax); __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    for (__pyx_t_16 = (-__pyx_v_kmax); __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      __pyx_t_17 = ((2 * __pyx_v_kmax) + (__pyx_v_k1 - __pyx_v_k2));
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_epsGz_perp.shape[0];
      __pyx_t_18 = ((2 * __pyx_v_kmax) + (__pyx_v_k1 - __pyx_v_k2));
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_epsGz_ll.shape[0];
      __pyx_t_19 = __pyx_v_j1;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_V.shape[0];
      __pyx_v_Sum = __Pyx_c_sum_double(__pyx_v_Sum, __Pyx_c_prod_double(__Pyx_c_sum_double(__Pyx_c_prod_double(__Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_epsGz_perp.data + __pyx_t_17 * __pyx_v_epsGz_perp.strides[0]) ))), __pyx_t_double_complex_from_parts(__pyx_v_Gz2, 0)), __pyx_t_double_complex_from_parts(__pyx_v_Gz1, 0)), __Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_epsGz_ll.data + __pyx_t_18 * __pyx_v_epsGz_ll.strides[0]) ))), __pyx_t_double_complex_from_parts((pow(__pyx_v_Gx, 2.0) + pow(__pyx_v_Gy, 2.0)), 0))), (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_V.data + __pyx_t_19 * __pyx_v_V.strides[0]) )))));

      __pyx_v_j1 = (__pyx_v_j1 + 1);
    }

    __pyx_t_20 = __pyx_v_index;
    if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_b_n.shape[0];
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_b_n.data + __pyx_t_20 * __pyx_v_b_n.strides[0]) )) = __pyx_v_Sum;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "PoissonSolver.matvec2D.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "PoissonSolver.matvec2D.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "PoissonSolver.matvec2D.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "PoissonSolver.matvec2D._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_PoissonSolver_MV_2D_cy_matvec2D, __pyx_k_PoissonSolver_MV_2D_cy_matvec2D, sizeof(__pyx_k_PoissonSolver_MV_2D_cy_matvec2D), 0, 0, 1, 0},
  {&__pyx_n_s_PoissonSolver_matvec2D, __pyx_k_PoissonSolver_matvec2D, sizeof(__pyx_k_PoissonSolver_matvec2D), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedConstants(void) {
  ...
  __pyx_tuple__26 = PyTuple_Pack(24, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_kmax, __pyx_n_s_celldm3, __pyx_n_s_pi, __pyx_n_s_epsGz_perp, __pyx_n_s_epsGz_ll, __pyx_n_s_b_1, __pyx_n_s_b_2, __pyx_n_s_V, __pyx_n_s_Gz1, __pyx_n_s_Gz2, __pyx_n_s_Gx, __pyx_n_s_Gy, __pyx_n_s_pi2_celldm3, __pyx_n_s_k_t, __pyx_n_s_k1, __pyx_n_s_k2, __pyx_n_s_j1, __pyx_n_s_p, __pyx_n_s_q, __pyx_n_s_index, __pyx_n_s_b_n, __pyx_n_s_Sum); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(10, 0, 24, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_PoissonSolver_MV_2D_cy_matvec2D, __pyx_n_s_matvec2D, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 6, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_PoissonSolver__matvec2D) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "PoissonSolver.matvec2D")) {
      if (unlikely(PyDict_SetItemString(modules, "PoissonSolver.matvec2D", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13PoissonSolver_8matvec2D_1matvec2D, NULL, __pyx_n_s_PoissonSolver_matvec2D); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init PoissonSolver.matvec2D", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PoissonSolver.matvec2D");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
