...
static char __pyx_k_Gz1[] = "Gz1";
static char __pyx_k_Gz2[] = "Gz2";
static char __pyx_k_Sum[] = "Sum";
static char __pyx_k_b_1[] = "b_1";
static char __pyx_k_b_2[] = "b_2";
static char __pyx_k_b_n[] = "b_n";
static char __pyx_k_k_t[] = "k_t";
...
static char __pyx_k_epsGz_ll[] = "epsGz_ll";
static char __pyx_k_itemsize[] = "itemsize";
static char __pyx_k_matvec2D[] = "matvec2D";
static char __pyx_k_TypeError[] = "TypeError";
static char __pyx_k_enumerate[] = "enumerate";
static char __pyx_k_IndexError[] = "IndexError";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_epsGz_perp[] = "epsGz_perp";
static char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static char __pyx_k_MemoryError[] = "MemoryError";
static char __pyx_k_pi2_celldm3[] = "pi2_celldm3";
...
static char __pyx_k_home_mitnaik_codes_CoFFEE_Poiss[] = "/home/mitnaik/codes/CoFFEE/PoissonSolver/MV_2D_cy/matvec2D.pyx";
...
static PyMethodDef __pyx_mdef_8matvec2D_1matvec2D = {"matvec2D", (PyCFunction)__pyx_pw_8matvec2D_1matvec2D, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8matvec2D_1matvec2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("matvec2D (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_j)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_kmax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_celldm3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_pi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_epsGz_perp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_epsGz_ll)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b_1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b_2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_V)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, 9); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "matvec2D") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_i = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_i == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_j = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_j == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_kmax = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_kmax == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_celldm3 = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_celldm3 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_pi = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_pi == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_epsGz_perp = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(values[5]); if (unlikely(!__pyx_v_epsGz_perp.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_epsGz_ll = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(values[6]); if (unlikely(!__pyx_v_epsGz_ll.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_b_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7]); if (unlikely(!__pyx_v_b_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_b_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8]); if (unlikely(!__pyx_v_b_2.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_V = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(values[9]); if (unlikely(!__pyx_v_V.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("matvec2D", 1, 10, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(((2 * __pyx_v_kmax) + 1)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, ((PyObject *)((PyObject*)(&PyComplex_Type)))) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_8 = 1;
  if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_b_1.shape[0];
  __pyx_t_9 = 1;
  if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_b_2.shape[0];
  __pyx_v_Gy = ((__pyx_v_i * (*((double *) ( /* dim=0 */ (__pyx_v_b_1.data + __pyx_t_8 * __pyx_v_b_1.strides[0]) )))) + (__pyx_v_j * (*((double *) ( /* dim=0 */ (__pyx_v_b_2.data + __pyx_t_9 * __pyx_v_b_2.strides[0]) )))));
 ...
 */
  ...
  __pyx_v_pi2_celldm3 = (__pyx_t_10 / __pyx_v_celldm3);
 ...
 *     Sum = 0.
 */
  __pyx_t_11 = (__pyx_v_kmax + 1);
  for (__pyx_t_12 = (-__pyx_v_kmax); __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
 ...
 *     b_n[index]=Sum
 */
      __pyx_t_15 = ((2 * __pyx_v_kmax) + (__pyx_v_k1 - __pyx_v_k2));
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_epsGz_perp.shape[0];
      __pyx_t_16 = ((2 * __pyx_v_kmax) + (__pyx_v_k1 - __pyx_v_k2));
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_epsGz_ll.shape[0];
      __pyx_t_17 = __pyx_v_j1;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_V.shape[0];
      __pyx_v_Sum = __Pyx_c_sum(__pyx_v_Sum, __Pyx_c_prod(__Pyx_c_sum(__Pyx_c_prod(__Pyx_c_prod((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_epsGz_perp.data + __pyx_t_15 * __pyx_v_epsGz_perp.strides[0]) ))), __pyx_t_double_complex_from_parts(__pyx_v_Gz2, 0)), __pyx_t_double_complex_from_parts(__pyx_v_Gz1, 0)), __Pyx_c_prod((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_epsGz_ll.data + __pyx_t_16 * __pyx_v_epsGz_ll.strides[0]) ))), __pyx_t_double_complex_from_parts((pow(__pyx_v_Gx, 2.0) + pow(__pyx_v_Gy, 2.0)), 0))), (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_V.data + __pyx_t_17 * __pyx_v_V.strides[0]) )))));
 ...
 */
    ...
    if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_b_n.shape[0];
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_b_n.data + __pyx_t_14 * __pyx_v_b_n.strides[0]) )) = __pyx_v_Sum;
 ...
 */
  ...
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_b_n, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
 ...
 *   cdef int k_t,k1, k2, j1, p, q, index
 */
  __pyx_tuple__18 = PyTuple_Pack(24, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_kmax, __pyx_n_s_celldm3, __pyx_n_s_pi, __pyx_n_s_epsGz_perp, __pyx_n_s_epsGz_ll, __pyx_n_s_b_1, __pyx_n_s_b_2, __pyx_n_s_V, __pyx_n_s_Gz1, __pyx_n_s_Gz2, __pyx_n_s_Gx, __pyx_n_s_Gy, __pyx_n_s_pi2_celldm3, __pyx_n_s_k_t, __pyx_n_s_k1, __pyx_n_s_k2, __pyx_n_s_j1, __pyx_n_s_p, __pyx_n_s_q, __pyx_n_s_index, __pyx_n_s_b_n, __pyx_n_s_Sum); if (unlikely(!__pyx_tuple__18)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__18);
  __Pyx_GIVEREF(__pyx_tuple__18);
  __pyx_codeobj__19 = (PyObject*)__Pyx_PyCode_New(10, 0, 24, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__18, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_mitnaik_codes_CoFFEE_Poiss, __pyx_n_s_matvec2D, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__19)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmatvec2D(void); /*proto*/
PyMODINIT_FUNC initmatvec2D(void)
#else
PyMODINIT_FUNC PyInit_matvec2D(void); /*proto*/
PyMODINIT_FUNC PyInit_matvec2D(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_matvec2D(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "matvec2D")) {
      if (unlikely(PyDict_SetItemString(modules, "matvec2D", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *   cdef int k_t,k1, k2, j1, p, q, index
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8matvec2D_1matvec2D, NULL, __pyx_n_s_matvec2D); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_matvec2D, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
